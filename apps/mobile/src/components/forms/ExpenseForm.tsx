...
export function ExpenseForm({
  ...
  }, [initialValues?.notes, initialValues?.paymentMethod]);
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <View style={styles.card}>
            ...
            <SuggestionChips
              label="Suggestions"
              suggestions={suggestions.expenseTitles}
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <View style={styles.card}>
            ...
            <SuggestionChips
              label="Usually"
              suggestions={suggestions.expenseAmounts}
            ...
            <View style={styles.labelRow}>
              ...
              {suggestions.expenseCategory ? (
                <Text style={styles.aiHint}>
                  AI suggests: {suggestions.expenseCategory.toLowerCase()}
                </Text>
              ) : null}
            </View>
            <View style={styles.chipRow}>
              {EXPENSE_CATEGORIES.map((category) => (
                <Text
                  ...
                  style={[
                    styles.choiceChip,
                    field.value === category && styles.choiceChipActive,
                  ]}
                >
        ...
        >
          <View>
            ...
            <Text style={styles.detailsHint}>
              Payment method and notes stay optional.
            </Text>
          </View>
                  ...
                  <View style={styles.chipRow}>
                    {PAYMENT_METHODS.map((method) => (
                      <Text
                        ...
                        style={[
                          styles.choiceChip,
                          field.value === method && styles.choiceChipActive,
                        ]}
                      >
...
const styles = StyleSheet.create({
  ...
  secondaryBlock: { gap: spacing.sm, paddingTop: spacing.sm },
